...
exports.getKudosCount = exports.listReceivedKudos = exports.sendKudos = void 0;
...
async function sendKudos(req, res) {
    ...
    try {
        const { data: senderRow } = await supabase_1.supabase
            .from('users')
            .select('name')
            .eq('id', senderId)
            .maybeSingle();
...
async function listReceivedKudos(req, res) {
...
exports.listReceivedKudos = listReceivedKudos;
// GET /kudos/count/:userId — total received count (used in Profile stat row).
async function getKudosCount(req, res) {
    const { userId } = req.params;
...
exports.getKudosCount = getKudosCount;
